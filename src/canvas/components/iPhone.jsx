...
export default function Phone(props) {
  ...
  const texture = useTexture('/models/iphone/textures/wfh.png')
  console.log(materials)
  useEffect(() => {
    // console.log(materials['Material.001'])
    materials['material_7'].map = texture
