var e=Object.defineProperty,t=Object.defineProperties,n=Object.getOwnPropertyDescriptors,i=Object.getOwnPropertySymbols,l=Object.prototype.hasOwnProperty,a=Object.prototype.propertyIsEnumerable,r=(t,n,i)=>n in t?e(t,n,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[n]=i,o=(e,t)=>{for(var n in t||(t={}))l.call(t,n)&&r(e,n,t[n]);if(i)for(var n of i(t))a.call(t,n)&&r(e,n,t[n]);return e},c=(e,i)=>t(e,n(i));import{r as s,B as m,R as p,a as d,b as h,s as g,c as u,u as f,L as x,S as w,d as E,e as v,f as y,i as b,g as $,h as k,C as j,j as z,M as C,k as I,l as T,O as S,m as _,n as A,H as P,o as L,p as H,q as M,A as O,t as q,v as F,D as W,w as D,x as N,P as G,y as R,z as B,E as U,F as Q,G as V,I as Y,J as Z,K,N as X,Q as J}from"./vendor.4cdab156.js";!function(){const e=document.createElement("link").relList;if(!(e&&e.supports&&e.supports("modulepreload"))){for(const e of document.querySelectorAll('link[rel="modulepreload"]'))t(e);new MutationObserver((e=>{for(const n of e)if("childList"===n.type)for(const e of n.addedNodes)"LINK"===e.tagName&&"modulepreload"===e.rel&&t(e)})).observe(document,{childList:!0,subtree:!0})}function t(e){if(e.ep)return;e.ep=!0;const t=function(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerpolicy&&(t.referrerPolicy=e.referrerpolicy),"use-credentials"===e.crossorigin?t.credentials="include":"anonymous"===e.crossorigin?t.credentials="omit":t.credentials="same-origin",t}(e);fetch(e.href,t)}}();const ee={mobile:640,tablet:940,smallLaptop:1200,laptop:1440,laptopMedium:1600,largeLaptop:1800,desktop:1920,largeDesktop:2560},te=e=>window.innerWidth<=ee[e],ne=()=>`@media (max-width: ${ee.mobile}px)`,ie=()=>`@media (max-width: ${ee.tablet}px)`,le=()=>`@media (max-width: ${ee.smallLaptop}px)`,ae=()=>`@media (max-width: ${ee.laptop}px)`,re=()=>`@media (max-width: ${ee.desktop}px)`,oe=({padding:e=!0}={})=>`\n  margin: 0 auto;\n  width: 100%;\n  padding: 0 21%;\n\n  ${re()} {\n    padding: 0 17.1%;\n  }\n\n  ${ae()} {\n    padding: 0 11.4%;\n  }\n\n  ${ie()} {\n    padding: 0 5%;\n  }\n\n  ${ne()} {\n    width: 100%;\n    ${e&&"padding: 1em;"} \n  }\n`,ce=e=>{const t=({children:e})=>p.createElement("p",null,e),n={renderNode:{[m.PARAGRAPH]:(e,n)=>p.createElement(t,null,n)},renderText:e=>e.split("\n").flatMap(((e,t)=>[t>0&&p.createElement("br",{key:`${e}_${t}`}),e]))};return s.documentToReactComponents(e.json,n)},se=[{name:"🇸🇪 Svenska",value:"sv"},{name:"🇬🇧 English",value:"en-US"}],me=d({key:"locale",default:se[0]}),pe=d({key:"content",default:null}),de=d({key:"project",default:null}),he=d({key:"text-page",default:null}),ge=d({key:"appademi-content",default:null}),ue={project:de,text:he,appademi:ge},fe=d({key:"active-page-type",default:null}),xe=h({key:"footer-content",get:({get:e})=>{const t=e(pe),n=e(fe);if(n){const t=e(ue[n]);if(t&&t.footer)return t.footer}return t&&t.footer}}),we=g.div`
  height: ${128}px;
...
`,$e=({id:e})=>{const t=(e=>{const t=E(me),[n]=v({query:"\nquery($id:String!, $locale: String!) {\n  textPage(id: $id, locale: $locale) {\n   \tname\n    content {\n      json\n    }\n  }\n}\n",variables:{id:e,locale:t.value}}),[i,l]=u(he),{data:a}=n;return y.exports.useEffect((()=>{a&&l(a.textPage)}),[a,l]),i})(e);return t?p.createElement(be,null,ce(t.content)):null},ke=g.div`
  margin: 25px auto;
  display: flex;
...
`,Ae=({title:e,googlePlay:t,appstore:n})=>p.createElement(_e,null,p.createElement("span",null,e),p.createElement("a",{href:n,target:"_blank",rel:"noopener noreferrer"},p.createElement("img",{src:"/img/assets/appstore-badge.png",alt:"Appstore button",style:{marginTop:10}})));I();const Pe=g.div`
  position: relative;
  width: 100%;
  height: 800px;
...
`,Be=({title:e,link:t,image:n,tags:i})=>p.createElement("a",{href:t},p.createElement(Ge,null,p.createElement("img",{src:n.url}),p.createElement(Re,null,p.createElement("h3",null,e),p.createElement("span",null,i.join(", "))))),Ue=g.div`
  margin-bottom: 50px;
  display: grid;
...
`,_t=({article:e})=>p.createElement(St,null,p.createElement("div",null,p.createElement("img",{src:e.publisherLogo.url,alt:`${e.publisher} logo`})),p.createElement("span",null,e.publisher),p.createElement("a",{href:e.link,target:"_blank",rel:"noopener noreferrer"},e.title)),At=({articles:e,title:t})=>p.createElement(Tt,null,p.createElement("h2",null,t),p.createElement("div",null,e.map(((e,t)=>p.createElement(_t,{article:e,key:`Article_${t}`}))))),Pt=g.a`
  ...
  ${({twitter:e})=>e&&"\n    color: #00acee;\n    border-color: #00acee;\n  "}
`;var Lt=({children:e,href:t,twitter:n,to:i})=>{const l=p.createElement(Pt,{href:t,target:"_blank",rel:"noopener noreferrer",twitter:n},e);return i?p.createElement(x,{to:i,style:{textDecoration:"none"}},l):l};const Ht=g.div`
  margin-top: 50px;
