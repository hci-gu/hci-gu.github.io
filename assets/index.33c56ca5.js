...
`,Be=({title:e,link:t,image:n,tags:i})=>p.createElement("a",{href:t},p.createElement(Ge,null,p.createElement("img",{src:n.url}),p.createElement(Re,null,p.createElement("h3",null,e),p.createElement("span",null,i.join(", "))))),Ue=h.div`
  margin-bottom: 50px;
  display: grid;
...
`,_t=({article:e})=>p.createElement(St,null,p.createElement("div",null,p.createElement("img",{src:e.publisherLogo.url,alt:`${e.publisher} logo`})),p.createElement("span",null,e.publisher),p.createElement("a",{href:e.link,target:"_blank",rel:"noopener noreferrer"},e.title)),At=({articles:e,title:t})=>p.createElement(Tt,null,p.createElement("h2",null,t),p.createElement("div",null,e.map(((e,t)=>p.createElement(_t,{article:e,key:`Article_${t}`}))))),Pt=h.a`
  ...
  ${({twitter:e})=>e&&"\n    color: #00acee;\n    border-color: #00acee;\n  "}
`;var Lt=({children:e,href:t,twitter:n,to:i})=>{const l=p.createElement(Pt,{href:t,target:"_blank",rel:"noopener noreferrer",twitter:n},e);return i?p.createElement(x,{to:i,style:{textDecoration:"none"}},l):l};const Ht=h.div`
  margin-top: 50px;
