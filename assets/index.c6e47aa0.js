...
`,Se=({id:e})=>{const t=(e=>{const t=k(ye),[i]=v({query:"\nquery($id:String!, $locale: String!) {\n  textPage(id: $id, locale: $locale) {\n   \tname\n    content {\n      json\n    }\n  }\n}\n",variables:{id:e,locale:t.value}}),[l,n]=y(Fe),{data:o}=i;return x.exports.useEffect((()=>{o&&n(o.textPage)}),[o,n]),l})(e);return t?p.createElement(Ce,null,he(t.content)):null},qe=u.div`
  margin: 25px auto;
  display: flex;
...
`,Be=({title:e,description:t})=>p.createElement(qe,null,p.createElement("h2",null,e),he(t)),$e=()=>{const[e,t]=x.exports.useState(window.innerWidth);return x.exports.useEffect((()=>{const e=()=>t(window.innerWidth);return window.addEventListener("resize",e),()=>window.removeEventListener("resize",e)}),[]),{width:e}},je=()=>{const{width:e}=$e();let t="screen";return Object.keys(oe).reverse().forEach((i=>{e<=oe[i]&&(t=i)})),t},Ie=u.div`
...
`,Ue=({title:e,googlePlay:t,appstore:i})=>p.createElement(Ne,null,p.createElement("span",null,e),p.createElement("a",{href:i,target:"_blank",rel:"noopener noreferrer"},p.createElement("img",{src:"/img/assets/appstore-badge.png",alt:"Appstore button",style:{marginTop:10}})));S();const Re=u.div`
  position: relative;
  width: 100%;
  height: 800px;
...
`,He=()=>p.createElement(Re,null,p.createElement("div",null,p.createElement(q,{camera:{fov:60,position:[-3.5,3,-4.5]},dpr:[1,2],color:"#000000"},p.createElement(B,{position:[0,0,0],enablePan:!1,enableZoom:!1,maxPolarAngle:Math.PI/3.2,minPolarAngle:Math.PI/3.2}),p.createElement($,{material:p.createElement(j,null)},p.createElement(I,{transform:!0,position:[ae("laptopMedium")?1:ae("largeLaptop")?2:2.5,-1,0]},p.createElement(Le,null,p.createElement(Ue,{title:"Ladda ner appen!",googlePlay:"https://play.google.com/store/apps/details?id=com.wfhmovement.app",appstore:"https://apps.apple.com/us/app/id1518224904"})))),p.createElement(x.exports.Suspense,{fallback:null},p.createElement(D,{adjustCamera:!1,environment:"studio",preset:"rembrandt",intensity:.75,contactShadowOpacity:0,shadowBias:-.0015},p.createElement(ze,null))),p.createElement(A,{"rotation-x":Math.PI/2,position:[0,-2.5,0],opacity:.4,width:20,height:30,blur:1.25,far:10})))),Te=u.div`
  position: absolute;
  width: 100vw;
  height: 100%;
  z-index: -1;
...
`,Nt=({article:e})=>p.createElement(zt,null,p.createElement("div",null,p.createElement("img",{src:e.publisherLogo.url,alt:`${e.publisher} logo`})),p.createElement("span",null,e.publisher),p.createElement("a",{href:e.link,target:"_blank",rel:"noopener noreferrer"},e.title)),Ut=({articles:e,title:t})=>p.createElement(At,null,p.createElement("h2",null,t),p.createElement("div",null,e.map(((e,t)=>p.createElement(Nt,{article:e,key:`Article_${t}`}))))),Rt=u.a`
  ...
  ${({twitter:e})=>e&&"\n    color: #00acee;\n    border-color: #00acee;\n  "}
`;var Lt=({children:e,href:t,twitter:i,to:l})=>{const n=p.createElement(Rt,{href:t,target:"_blank",rel:"noopener noreferrer",twitter:i},e);return l?p.createElement(g,{to:l,style:{textDecoration:"none"}},n):n};const Ht=u.div`
  margin-top: 50px;
...
`,Kt=p.memo((()=>{const e={theme:Yt,data:Xt,xField:"hour",yField:"value",smooth:!0,animation:{appear:{animation:"path-in",delay:500,duration:3500}},yAxis:{min:0,max:800,label:{style:{fontSize:18}}},xAxis:{label:{autoHide:{type:"equidistance",cfg:{minGap:100}},style:{fontSize:18}}},seriesField:"series",legend:!0};return p.createElement(P,r({},e))})),ei=()=>{const e=x.exports.useRef(),{fps:t}=M.useVideoConfig(),i=M.useCurrentFrame(),l=M.interpolate(i,[0,1*t,7*t,7.5*t],[0,1,1,0]);M.spring({fps:t,from:0,to:1,frame:l});const n=M.interpolate(i,[0,60],[0,60],{extrapolateRight:"clamp"}),o=M.spring({fps:t,from:200,to:0,frame:n});return p.createElement(p.Fragment,null,p.createElement(Qt,{style:{opacity:l,transform:`translateY(${o}px)`}},p.createElement(Vt,null),p.createElement(Zt,null,p.createElement(Kt,{parentRef:e}))))},ti={mass:1,damping:12,stiffness:100};function ii(){const e=M.useCurrentFrame(),t=x.exports.useRef(),{scene:i,nodes:l,materials:n}=E("/models/smart_phone/scene.gltf"),o=w("/models/smart_phone/screen.png");w("/models/smart_phone/screen_2.png"),x.exports.useEffect((()=>{}),[e]);const{rotateX:a,left:r,depth:s,top:c,scaleX:d,scale:m}=(()=>{const{fps:e,width:t}=M.useVideoConfig(),i=M.useCurrentFrame(),l=M.interpolate(i,[0,120],[0,120],{extrapolateRight:"clamp",easing:M.Easing.quad}),n=M.interpolate(i,[0,120,180],[0,0,60],{extrapolateRight:"clamp",easing:M.Easing.quad}),o=M.spring({fps:e,from:Math.PI,to:0,frame:l,config:ti}),a=M.spring({fps:e,from:-2,to:0,frame:l,config:ti}),r=M.spring({fps:e,from:-8,to:0,frame:l,config:ti}),s=M.spring({fps:e,from:0,to:t<940?0:-Math.PI/5,frame:n,config:ti}),c=M.spring({fps:e,from:0,to:t<940?0:3,frame:n,config:ti}),d=M.spring({fps:e,from:-1.05,to:t<940?-1.05:-.9,frame:n,config:ti}),p=M.spring({fps:e,from:1,to:t<940?.6:1,frame:n,config:ti});return{rotateX:o+s,left:c,depth:a,top:r+M.spring({fps:e,from:0,to:t<940?-1.5:0,frame:n,config:ti}),scaleX:d,scale:p}})();return p.createElement("group",{ref:t,castShadow:!0,receiveShadow:!0,position:[r,c,s],rotation:[0,-Math.PI+a,0],scale:[d*m,-2.2*m,-.12*m]},p.createElement("mesh",{geometry:l.Cube_Camera_0.geometry,material:n.Camera}),p.createElement("mesh",{geometry:l.Cube_Metallic_phone_0.geometry,material:n.Metallic_phone}),p.createElement("mesh",{geometry:l.Cube_Screen_0.geometry},p.createElement("meshStandardMaterial",{map:o})))}E.preload(`${URL}/models/smart_phone/scene.gltf`);const li=u.div`
  position: absolute;
  left: 0;
  bottom: 10vh;
  width: 66.7%;
...
`,ni=()=>{const e=M.useCurrentFrame(),t=M.interpolate(e,[0,160,220],[0,0,1]),i=M.interpolate(e,[0,160,220],[0,0,200],{extrapolateRight:"clamp",easing:M.Easing.quad}),l=M.spring({fps:60,from:0,to:125,frame:i,config:{damping:100}});return p.createElement(li,{style:{opacity:t,marginBottom:l}},p.createElement("h1",null,"Testa själv med appen",p.createElement("br",null)," ",p.createElement("strong",null,"WFH Movement")),p.createElement("h2",null,"Och bidra till forskning"),p.createElement("a",{href:"https://apps.apple.com/us/app/id1518224904",target:"_blank",rel:"noopener noreferrer"},p.createElement("img",{src:"/img/assets/appstore-badge.png",alt:"Appstore button"})))},oi=()=>{const{width:e,height:t}=M.useVideoConfig(),[i]=x.exports.useState((()=>M.delayRender()));return x.exports.useEffect((()=>{setTimeout((()=>{M.continueRender(i)}),1e3)}),[]),p.createElement(M.AbsoluteFill,null,p.createElement(J.ThreeCanvas,{width:e,height:t,color:"white",antialias:!0,dpr:[1,2]},p.createElement("ambientLight",{intensity:.6}),p.createElement(ii,null),p.createElement(A,{"rotation-x":Math.PI/2,position:[0,-2.5,0],opacity:.8,width:30,height:30,blur:1.25,far:10})),p.createElement(ni,null))},ai=u.div`
  width: 100%;
  height: 100%;
  padding: 1rem 2rem;
...
`,ri=()=>{const{fps:e}=M.useVideoConfig();return p.createElement(M.AbsoluteFill,null,p.createElement(M.Sequence,{from:0,durationInFrames:16*e},p.createElement(ai,null)),p.createElement(M.Sequence,{from:0*e,durationInFrames:8*e},p.createElement(ei,null)),p.createElement(M.Sequence,{from:8*e,durationInFrames:16*e},p.createElement(oi,null)))},si=()=>p.createElement(ri,null),ci=u.div``,di=(e,t)=>{switch(e){case"mobile":case"tablet":return Math.floor(.9*t);case"laptop":case"smallLaptop":return 900;default:return 1200}},pi=()=>{const e=x.exports.useRef(),[t,i]=x.exports.useState(!1),l=je(),{width:n}=$e();return x.exports.useEffect((()=>{e.current&&e.current.addEventListener("timeupdate",(t=>{t.detail.frame>=900&&(e.current.pause(),i(!0))}))}),[]),p.createElement(ci,null,p.createElement(G.Player,{ref:e,controls:t,style:{margin:"0 auto"},autoPlay:!0,durationInFrames:960,compositionWidth:di(l,n),compositionHeight:720,fps:60,component:si}))},mi=u.div`
  margin: 0 auto;
  width: 75%;
  min-height: 100vh;
  font-family: 'Poppins';
...
`,Di=({title:e,introduction:t,callToAction:i,callToActionHref:l})=>p.createElement(Oi,null,p.createElement(Wi,null),p.createElement(Ci,null,p.createElement(Si,null,p.createElement(qi,null,e),p.createElement(Bi,null,he(t)),p.createElement("a",{href:l},p.createElement($i,null,i))),p.createElement(ji,{src:"/img/assets/hero-phone.png"},p.createElement(Ii,{src:"/img/assets/hero-phone.png"}),p.createElement("span",null,"App utvecklad av Appademin, läs mer"," ",p.createElement(Lt,{to:"/wfh-movement"},"här"),".")))),{Step:Ai}=X,zi=u.div`
  > div {
    margin-top: 50px;
...
`,Ui=(e,{status:t,index:i})=>p.createElement(Ni,null),Ri=({title:e,featuresCollection:t})=>{const i=je();return p.createElement(zi,null,p.createElement("h2",null,e),p.createElement("div",null,p.createElement(X,{current:-1,progressDot:Ui,style:{marignTop:25},direction:"mobile"===i?"vertical":"horizontal"},t.items.map((e=>p.createElement(Ai,{key:`Step_${e.title}`,title:e.title,description:p.createElement("div",null,he(e.description))}))))))},Li=u.div`
  > h1 {
    font-size: 48px;
  }
...
`,Mi=({title:e,featuresCollection:t})=>p.createElement(Li,null,p.createElement("h2",null,e),p.createElement(Hi,null,t.items.map((e=>(({title:e,description:t,graphic:i})=>p.createElement(Ti,{key:`Feature_${e}`},p.createElement(_i,null,p.createElement("img",{src:i.url,alt:e})),p.createElement("div",null,p.createElement("span",null,e),he(t))))(e)))));u.div``,u.div`
  margin: 32px auto;
  height: 425px;
  border-radius: 12px;
  background-color: #1b4079;
